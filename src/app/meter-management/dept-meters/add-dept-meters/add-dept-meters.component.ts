...
@Component({
    selector: 'add-dept-meters',
    templateUrl: 'add-dept-meters.component.html'
})
export class AddDeptMetersComponent implements OnInit {
    @Input() public data;
    ...
    ngOnInit() {
        ...
        if (this.data._id === undefined) {
            ...
            this.formHeader = 'Edit Dept Meter Details';
