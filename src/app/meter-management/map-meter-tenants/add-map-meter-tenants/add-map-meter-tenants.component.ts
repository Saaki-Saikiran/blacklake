...
@Component({
    selector: 'add-map-meter-tenants',
    templateUrl: 'add-map-meter-tenants.component.html'
})
export class AddMapMeterTenantsComponent implements OnInit {
    @Input() public data;
    ...
    ngOnInit() {
        ...
        if (this.data._id === undefined) {
            this.formHeader = 'Add Map a Meters to Tenant Details';
            this.buttonType = 'Add';
            ...
            this.formHeader = 'Edit Map a Meters to Tenant Details';
